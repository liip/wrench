...
@patch('wrench.commands.create_session_from_context')
def test_add_sends_encrypted_secret(create_session_from_context, add_resource, get_users, get_user, input, getpass,
                                    cli, gpg):
    ...
    create_session_from_context.return_value.user_fingerprint = gpg.get_fingerprint('john.doe')
...
@patch('wrench.services.passbolt_api.add_resource')
@patch('wrench.commands.create_session_from_context')
def test_add_with_sharing_encrypts_data_for_recipient(create_session_from_context, add_resource, get_users, get_user,
